...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.saveCreditCard.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.save-credit-cards.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('card_number') ? 'is-invalid' : '' }}" type="text" name="card_number" id="card_number" value="{{ old('card_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cvc') ? 'is-invalid' : '' }}" type="text" name="cvc" id="cvc" value="{{ old('cvc', '') }}">
                @if($errors->has('cvc'))
