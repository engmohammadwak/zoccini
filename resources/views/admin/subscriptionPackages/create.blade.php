...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.subscriptionPackage.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.subscription-packages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_branches') ? 'is-invalid' : '' }}" type="text" name="number_branches" id="number_branches" value="{{ old('number_branches', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('offer') ? 'is-invalid' : '' }}" type="text" name="offer" id="offer" value="{{ old('offer', '') }}">
                @if($errors->has('offer'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('have_map') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="have_map" id="have_map" value="1" {{ old('have_map', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('referral_price') ? 'is-invalid' : '' }}" type="text" name="referral_price" id="referral_price" value="{{ old('referral_price', '') }}">
