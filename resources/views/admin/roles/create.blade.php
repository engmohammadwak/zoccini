...
<div class="card" style="border: none; box-shadow: none; background: transparent;">
    ...
    <form method="POST" action="{{ route('admin.roles.store') }}" enctype="multipart/form-data">
        ...
        {{-- Basic Info --}}
        <div class="card" style="border-radius: 12px; border: 1px solid #e8eaf0; margin-bottom: 24px;">
            ...
            <div class="card-body" style="padding: 24px;">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="Role key name...">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar') }}" dir="rtl" placeholder="اسم الدور بالعربية">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text" name="title_en" id="title_en" value="{{ old('title_en') }}" placeholder="Role name in English">
        ...
        <div class="category-card">
            <div class="category-header" onclick="toggleCategory('{{ $catId }}')">
                <div class="category-title">
                    ...
                    <span class="category-badge">{{ $catPerms->count() }} صلاحية</span>
                </div>
