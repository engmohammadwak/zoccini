    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.coupons.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maximum_usage') ? 'is-invalid' : '' }}" type="text" name="maximum_usage" id="maximum_usage" value="{{ old('maximum_usage', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_day') ? 'is-invalid' : '' }}" type="text" name="start_day" id="start_day" value="{{ old('start_day') }}" required>
