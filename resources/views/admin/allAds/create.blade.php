    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.all-ads.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select onchange="select()" class="form-control select2 {{ $errors->has('category') ? 'is-invalid' : '' }}" name="category_id" id="category_id" required>
            ...
            <div id="offers" style="display:none;">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('number_requests') ? 'is-invalid' : '' }}" type="text" name="number_requests" id="number_requests" value="{{ old('number_requests', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('voucher_number') ? 'is-invalid' : '' }}" type="text" name="voucher_number" id="voucher_number" value="{{ old('voucher_number', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('withdraw_day') ? 'is-invalid' : '' }}" type="text" name="withdraw_day" id="withdraw_day" value="{{ old('withdraw_day') }}">
