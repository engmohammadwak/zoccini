...
<div class="content-wrapper" style="background:#f0f2f8;min-height:100vh;padding:24px;">
    ...
    <x-admin-table title="Point Types" icon="fas fa-award" color="gold" datatableClass="datatable-PointType" :count="$pointTypes->count()" createPermission="point_type_create" :createRoute="route('admin.point-types.create')" :createLabel="trans('global.add').' Type'">
