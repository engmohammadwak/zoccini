...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.subscriptionVip.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.subscription-vips.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_day') ? 'is-invalid' : '' }}" type="text" name="start_day" id="start_day" value="{{ old('start_day') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_day') ? 'is-invalid' : '' }}" type="text" name="end_day" id="end_day" value="{{ old('end_day') }}">
