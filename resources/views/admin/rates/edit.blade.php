    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.rates.update", [$rate->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                    @foreach($users as $id => $user)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $rate->user->id ?? '') == $id ? 'selected' : '' }}>{{ $user }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('restaurant') ? 'is-invalid' : '' }}" name="restaurant_id" id="restaurant_id">
                    @foreach($restaurants as $id => $restaurant)
                        <option value="{{ $id }}" {{ (old('restaurant_id') ? old('restaurant_id') : $rate->restaurant->id ?? '') == $id ? 'selected' : '' }}>{{ $restaurant }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="text" name="rating" id="rating" value="{{ old('rating', $rate->rating) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rate_1') ? 'is-invalid' : '' }}" type="text" name="rate_1" id="rate_1" value="{{ old('rate_1', $rate->rate_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rate_2') ? 'is-invalid' : '' }}" type="text" name="rate_2" id="rate_2" value="{{ old('rate_2', $rate->rate_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rate_3') ? 'is-invalid' : '' }}" type="text" name="rate_3" id="rate_3" value="{{ old('rate_3', $rate->rate_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rate_4') ? 'is-invalid' : '' }}" type="text" name="rate_4" id="rate_4" value="{{ old('rate_4', $rate->rate_4) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('comment') ? 'is-invalid' : '' }}" name="comment" id="comment">{{ old('comment', $rate->comment) }}</textarea>
