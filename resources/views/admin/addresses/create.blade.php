    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.addresses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nice_name') ? 'is-invalid' : '' }}" type="text" name="nice_name" id="nice_name" value="{{ old('nice_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apartment_no') ? 'is-invalid' : '' }}" type="text" name="apartment_no" id="apartment_no" value="{{ old('apartment_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional_direction') ? 'is-invalid' : '' }}" type="text" name="additional_direction" id="additional_direction" value="{{ old('additional_direction', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('landing_number') ? 'is-invalid' : '' }}" type="text" name="landing_number" id="landing_number" value="{{ old('landing_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_address') ? 'is-invalid' : '' }}" type="text" name="main_address" id="main_address" value="{{ old('main_address', '') }}">
