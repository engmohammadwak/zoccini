...
<div class="content-wrapper" style="background:#f0f2f8;min-height:100vh;padding:24px;">
    ...
    <x-admin-table title="Ticket Statuses" icon="fas fa-tag" color="teal" datatableClass="datatable-TicketStatus" :count="$ticketStatuses->count()" createPermission="ticket_status_create" :createRoute="route('admin.ticket-statuses.create')" :createLabel="trans('global.add').' Status'">
