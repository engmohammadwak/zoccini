                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                    ...
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                {{ optional($user->status)->name_ar ?? '' }}
                            </td>
                            <td>
                                @can('employees_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.employees.show', $user->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('employees_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.employees.edit', $user->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
