...
<head>
    ...
    <link href="{{ asset('local/public/css/adminltev3.css') }}" rel="stylesheet"/>
    ...
    <link href="{{ asset('local/public/css/custom.css') }}" rel="stylesheet"/>
...
<script src="{{ asset('local/public/js/main.js') }}"></script>
<script>
    $(function () {
