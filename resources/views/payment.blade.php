...
curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS => "transaction_amount=" . $price . "&currency=AED&" . $restaurant->address . "=Address&customer_city=" . optional($restaurant->city)->name . "&billing_country=" . optional($restaurant->country)->name . "&billing_state=" . optional($restaurant->city)->name . "&billing_postal_code=000000&customer_name=" . $user->name . "&customer_email=" . $user->email . "&customer_mobile=" . $user->phone,
...
<script type="text/javascript">
    ...
    foloosiHandler(response, function (e) {
        if (e.data.status == 'success') {
            ...
            $subscription =\App\Models\SubscriptionUser::find($subscription->id);
