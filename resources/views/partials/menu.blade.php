        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('user_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/permissions*") ? "menu-open" : "" }} {{ request()->is("admin/roles*") ? "menu-open" : "" }} {{ request()->is("admin/users*") ? "menu-open" : "" }} {{ request()->is("admin/user-statuses*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('user_status_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.user-statuses.index") }}" class="nav-link {{ request()->is("admin/user-statuses") || request()->is("admin/user-statuses/*") ? "active" : "" }}">
                ...
                @can('restaurants_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/restaurants*") ? "menu-open" : "" }} {{ request()->is("admin/categories*") ? "menu-open" : "" }} {{ request()->is("admin/items*") ? "menu-open" : "" }} {{ request()->is("admin/sitting-areas*") ? "menu-open" : "" }} {{ request()->is("admin/extras*") ? "menu-open" : "" }} {{ request()->is("admin/otherbranches*") ? "menu-open" : "" }} {{ request()->is("admin/payment-methods*") ? "menu-open" : "" }} {{ request()->is("admin/tables*") ? "menu-open" : "" }} {{ request()->is("admin/table-statuses*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('sitting_area_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.sitting-areas.index") }}" class="nav-link {{ request()->is("admin/sitting-areas") || request()->is("admin/sitting-areas/*") ? "active" : "" }}">
                            ...
                            @can('otherbranch_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.otherbranches.index") }}" class="nav-link {{ request()->is("admin/otherbranches") || request()->is("admin/otherbranches/*") ? "active" : "" }}">
                            ...
                            @can('table_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.tables.index") }}" class="nav-link {{ request()->is("admin/tables") || request()->is("admin/tables/*") ? "active" : "" }}">
                            ...
                            @can('table_status_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.table-statuses.index") }}" class="nav-link {{ request()->is("admin/table-statuses") || request()->is("admin/table-statuses/*") ? "active" : "" }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/deliveries*") ? "menu-open" : "" }} {{ request()->is("admin/delivery-companies*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('delivery_company_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.delivery-companies.index") }}" class="nav-link {{ request()->is("admin/delivery-companies") || request()->is("admin/delivery-companies/*") ? "active" : "" }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/order-types*") ? "menu-open" : "" }} {{ request()->is("admin/order-statuses*") ? "menu-open" : "" }} {{ request()->is("admin/orders*") ? "menu-open" : "" }} {{ request()->is("admin/cansel-reasons*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('cansel_reason_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.cansel-reasons.index") }}" class="nav-link {{ request()->is("admin/cansel-reasons") || request()->is("admin/cansel-reasons/*") ? "active" : "" }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/slide-shows*") ? "menu-open" : "" }} {{ request()->is("admin/ads-categories*") ? "menu-open" : "" }} {{ request()->is("admin/all-ads*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            @can('slide_show_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.slide-shows.index") }}" class="nav-link {{ request()->is("admin/slide-shows") || request()->is("admin/slide-shows/*") ? "active" : "" }}">
                            ...
                            @can('all_ad_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.all-ads.index") }}" class="nav-link {{ request()->is("admin/all-ads") || request()->is("admin/all-ads/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fab fa-adversal">
                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/subscription-packages*") ? "menu-open" : "" }} {{ request()->is("admin/subscription-vips*") ? "menu-open" : "" }} {{ request()->is("admin/subscription-users*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            @can('subscription_package_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.subscription-packages.index") }}" class="nav-link {{ request()->is("admin/subscription-packages") || request()->is("admin/subscription-packages/*") ? "active" : "" }}">
                            ...
                            @can('subscription_vip_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.subscription-vips.index") }}" class="nav-link {{ request()->is("admin/subscription-vips") || request()->is("admin/subscription-vips/*") ? "active" : "" }}">
                            ...
                            @can('subscription_user_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.subscription-users.index") }}" class="nav-link {{ request()->is("admin/subscription-users") || request()->is("admin/subscription-users/*") ? "active" : "" }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/reportings*") ? "menu-open" : "" }} {{ request()->is("admin/ticket-statuses*") ? "menu-open" : "" }} {{ request()->is("admin/tickets*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            @can('reporting_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.reportings.index") }}" class="nav-link {{ request()->is("admin/reportings") || request()->is("admin/reportings/*") ? "active" : "" }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/point-types*") ? "menu-open" : "" }} {{ request()->is("admin/points*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            @can('point_type_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.point-types.index") }}" class="nav-link {{ request()->is("admin/point-types") || request()->is("admin/point-types/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-exchange-alt">
                ...
                @can('favorite_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.favorites.index") }}" class="nav-link {{ request()->is("admin/favorites") || request()->is("admin/favorites/*") ? "active" : "" }}">
                ...
                @can('onbordering_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.onborderings.index") }}" class="nav-link {{ request()->is("admin/onborderings") || request()->is("admin/onborderings/*") ? "active" : "" }}">
