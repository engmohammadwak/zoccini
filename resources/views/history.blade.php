        ...
        <div class="page-content bg-gray-2">
            <div class="container pb-5">
                <section class="section wow fadeInUp" data-wow-delay="0.2s">
                    <div class="container">
                        <h2 class="title-section font-bold">{{web('History')}}</h2>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="bg-white rounded_md p-4 mb-4">
                                    <h3 class="font-medium mb-1">{{web('total')}}</h3>
                                    <h2 class="h1 font-medium mb-4 mb-lg-5">${{\App\Models\ReferralSubscription::where('user_loop_id' , \Illuminate\Support\Facades\Auth::id())->sum('price')}}</h2>
                                </div>
                            </div>
                                ...
                                <div class="container-table mb-4">
                                    <table class="table table-borderless table-striped mb-0">
                                        ...
                                        @foreach($subscription as $value)
                                            <tr>
                                                <td>{{\App\Models\Restaurant::find($value->user_id)->name}}</td>
                                                <td>{{$value->price}}</td>
                                                <td><span class="plans-nu plans-success">{{$value->plan->name}}</span></td>
...
{{--                            <div class="col-lg-4">--}}
{{--                                <div class="bg-white rounded_md p-4 mb-4">--}}
{{--                                    <h3 class="font-medium mb-1">{{web('Total Salary')}}</h3>--}}
{{--                                    <h2 class="h1 font-medium mb-4 mb-lg-5">${{\App\Models\ReferralSubscription::where('user_loop_id' , \Illuminate\Support\Facades\Auth::id())->sum('price')}}</h2>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="col-lg-4">--}}
{{--                                <div class="bg-white rounded_md p-4 mb-4">--}}
{{--                                    <h3 class="font-medium mb-1">{{web('Received')}}</h3>--}}
